	...
	<rapid:override name="title"><title>逻辑配置请求编辑</title></rapid:override>
	...
	<div id="container" style="height:560px;" >
		...
		<table style="margin:0px auto;">
			<tr>
	  				...
	  				<td>
	  					<input type="text" value="${webConfigCondition.flag}" id="flag" name="flag" readonly="readonly" class="easyui-validatebox" style="width:200px; height: 20px;"/>
	  				</td>
	  			</tr>
	  			<tr>
	  			...
	  			<tr>
	  				...
	  				<td>
	  					<textarea rows="5" cols="8" name="condition" id="condition" style="width:400px;overflow-y:scroll;">${webConfigCondition.condition}</textarea>
	  				</td>
	  			...
	  			<tr>
	  				...
	  				<td>
	  					<textarea rows="3" cols="8" name="tips" id="tips" style="width:400px;">${webConfigCondition.tips}</textarea>
	  				</td>
	  			</tr>
	  			<tr>
	...
	<script type="text/javascript">
		/* 初始化加载完成后执行 */
		$(function(){
			var conditionType = "${webConfigCondition.conditionType}";
			$("input[name='conditionType']").each(function(){
				var val = $(this).val();
			...
			$('#sumbitButton').click(function(){
				...
				$("#submitForm").ajaxSubmit({
					url: '${root}/truefalse/updateConfigCondition.do',
					dataType: 'json',
					success: function(data) {
						if(data.successful){
							$.messager.alert("操作提示", "编辑逻辑请求成功!","info",function(){
