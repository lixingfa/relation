...
public class EASYUIConstant {
	...
	//grid
	public static final String TREEGRID_DEF = "$('#\\w').treegrid({";
	public static final String DATAGRID_DEF = "$('#\\w').datagrid({";
	...
	public static final String TREE_DEF = "$([ ]?['\"]{1}[ ]?#\\w[ ]?['\"]{1}[ ]?).tree([ ]?{";//完全是为了预防奇葩写法
