package com.garlane.relation.analyze.model.dataBase;
...
public class ColumnModel {
	...
	public ColumnModel(String name,String title,Constant.dataType dataType,Long dataLength){
		this.name = name;
		this.title = title;		
	...
	public void setDataType(Constant.dataType dataType) {
		this.dataType = dataType;
	}
